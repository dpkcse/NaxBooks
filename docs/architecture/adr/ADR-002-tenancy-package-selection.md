# ADR-002: Tenancy Package Selection
...
## Decision
Select stancl/tenancy as preferred package, pending Composer dry-run compatibility confirmation. Use central records for identity, tenancy, domains, membership, invitations, provisioning, platform audit, and future plans/subscriptions. Use tenant databases for companies, branches, fiscal years, periods, tenant permissions, company access, tenant audit, and future business transactions.
